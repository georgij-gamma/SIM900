...
_0x0:
	.DB  0x48,0x65,0x6C,0x6C,0x6F,0x21,0x0,0x48
	.DB  0x6F,0x77,0x20,0x61,0x72,0x65,0x20,0x79
	.DB  0x6F,0x75,0x3F,0x0,0x53,0x6C,0x61,0x76
	.DB  0x61,0x20,0x4F,0x74,0x63,0x75,0x2C,0x20
	.DB  0x53,0x79,0x6E,0x75,0x0,0x49,0x20,0x53
	.DB  0x76,0x79,0x61,0x74,0x6F,0x6D,0x75,0x20
	.DB  0x44,0x75,0x68,0x75,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00F6 delay_ms(3000);
	...
	LDI  R31,HIGH(3000)
	RCALL SUBOPT_0x4
; 0000 00F7 lcd_clear(); //Очистить экран ЖКИ
	RCALL SUBOPT_0x5
...
; 0000 00FE delay_ms(5000);
	...
	LDI  R31,HIGH(5000)
	RCALL SUBOPT_0x4
; 0000 00FF lcd_clear(); //Очистить экран ЖКИ
	RCALL SUBOPT_0x5
; 0000 0100 delay_ms(1500);
; 0000 0101 lcd_clear(); //Очистить экран ЖКИ
	RCALL _lcd_clear
...
; 0000 0109 putchar(getchar());
	...
	ST   -Y,R30
	RCALL _putchar
; 0000 010A // Направлять на ножку TXD данные принятые на RXD
; 0000 010B // вы можете печатать символы в левом окне терминала в VMLAB
; 0000 010C // и они будут появляться в правом окне терминала.
; 0000 010D lcd_putchar(getchar()); // Направлять на lcd данные принятые на RXD
	RCALL _getchar
	ST   -Y,R30
	RCALL _lcd_putchar
; 0000 010E       }
